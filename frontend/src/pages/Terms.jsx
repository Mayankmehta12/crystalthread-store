  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-hero">
        ...
        <p>Welcome to <span>CrystalThread</span></p>
      </div>
      ...
      <div className="legal-container">
        ...
        <div className="legal-card">
          ...
          <p>
            By accessing CrystalThread, you agree to use our services for lawful
        ...
        <div className="legal-card">
          ...
          <p>
            CrystalThread is not liable for indirect or incidental damages arising
        ...
        <div className="legal-card">
          <h3>📞 Contact Us</h3>
          <p>
            For any questions, contact us at <b>crystalthread.in@gmail.com</b>
          </p>
        </div>
