...
export const sendAccountStatusEmail = async (email, isBanned) => {
  try {
    ...
    const subject = isBanned
      ? "🚫 Account Suspended | CrystalThread"
      : "✅ Account Restored | CrystalThread";
    ...
    const htmlContent = isBanned
      ? generateTemplate({
          ...
          message: `
            ...
            <a href="mailto:crystalthread.in@gmail.com">Contact Support</a>
          `
        })
      : generateTemplate({
          ...
          message: `
            ...
            You can now continue shopping on CrystalThread.<br/><br/>
